...
> 
> You’ve probably noticed that Docker generates some interesting default container names! Interested in where these come from? Take a look at [the name generator code in the Docker GitHub repository](https://github.com/moby/moby/blob/master/pkg/namesgenerator/names-generator.go). And, as highlighted in [this short blog post](https://frightanic.com/computers/docker-default-container-names/), take a look at the code in the GetRandomName function!
{: .callout}
